return {
    ...
    opts = {
        ...
        dashboard = {
            ...
            sections = {
                ...
                {
                    section = "terminal",
                    cmd = ("ascii-image-converter %q -C -c")
                        :format(vim.fn.expand("~/Documents/doraemon.JPG")),
                    pane = 2,
                    indent = 4,
                    height = 30,
                },
    ...
    },
    {
        ...
        keys = {
            ...
            { "<leader>pT", function() require("snacks").picker.todo_commens({ keywords = { "TODO", "FIX", "FIXME" } }) end, desc = "Todo/Fix/Fixme" },
        },
    },
}
