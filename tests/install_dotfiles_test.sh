...
assert_absent "$home_dir/AGENTS.md"
assert_absent "$home_dir/CLAUDE.md"
...
assert_absent "$home_dir/.agents/AGENTS.md"
assert_absent "$home_dir/.agents/skills"
assert_absent "$home_dir/.claude/CLAUDE.md"
assert_absent "$home_dir/.claude/skills"
assert_absent "$home_dir/.codex/AGENTS.md"
...
assert_symlink "$home_dir/.apm/apm.yml" "$repo_root/.apm/apm.yml"
